        ...
        const renderItem = ({ item, index }) => (
            <View style={{
                ...
                <View style={{ flexDirection: 'row', padding: SIZES.padding, alignItems: 'center' }}>
                    ...
                    <Text style={{ fontSize: SIZES.h3, lineHeight: 22, color: selectedCategory.color, }}>{selectedCategory.name}</Text>
                </View>

                {/* Expense Description */}
                <View style={{ paddingHorizontal: SIZES.padding }}>
                    {/* Title and description */}
                    <Text style={{ fontSize: SIZES.h2, lineHeight: 30 }}>{item.title}</Text>
                    <Text style={{ fontSize: SIZES.body3, lineHeight: 22, flexWrap: 'wrap', color: COLORS.darkgray }}>
                        {item.description}
                    </Text>

                    {/* Location */}
                    <Text style={{ marginTop: SIZES.padding, fontSize: SIZES.h4, lineHeight: 22}}>Location</Text>
                    <View style={{ flexDirection: 'row' }}>
                        <Image
                            source={icons.pin}
                            style={{
                        ...
                        />
                        <Text style={{ marginBottom: SIZES.base, color: COLORS.darkgray, fontSize: SIZES.body4, lineHeight: 22 }}>{item.location}</Text>
                    </View>
                </View>
                ...
                >
                    <Text style={{ color: COLORS.white, fontSize: SIZES.body3, lineHeight: 22}}>CONFIRM {item.total.toFixed(2)} USD</Text>
                </View>
            </View>
        )
            ...
            <View>
...

                {
                    ...
                    <View style={{ alignItems: 'center', justifyContent: 'center', height: 300 }}>
                        <Text style={{ color: COLORS.primary, fontSize: SIZES.h3, lineHeight: 22 }}>No Record</Text>
                    </View>
                }
        ...
        const renderItem = ({ item }) => (
            ...
            >
                ...
                <View style={{ flex: 1, flexDirection: 'row', alignItems: 'center' }}>
                    ...
                    <Text style={{ marginLeft: SIZES.base, color: (selectedCategory && selectedCategory.name == item.name) ? COLORS.white : COLORS.primary, fontSize: SIZES.h3, lineHeight: 22 }}>{item.name}</Text>
                </View>

                {/* Expenses */}
                <View style={{ justifyContent: 'center' }}>
                    <Text style={{ color: (selectedCategory && selectedCategory.name == item.name) ? COLORS.white : COLORS.primary, fontSize: SIZES.h3, lineHeight: 22 }}>{item.y} USD - {item.label}</Text>
                </View>
            </TouchableOpacity>
        )
